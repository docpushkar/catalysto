(function(){
  ...
  function openModal(src){ if(!modal||!iframe) return; iframe.src=src; modal.classList.add('open'); document.body.style.overflow='hidden'; }
  function closeModal(){ if(!modal||!iframe) return; iframe.src=''; modal.classList.remove('open'); document.body.style.overflow=''; }
  ...
  /* Injected once on every page via nav.js — box-shadow pulse, no flickering rings */
